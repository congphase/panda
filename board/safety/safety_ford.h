...
static int ford_rx_hook(CAN_FIFOMailBox_TypeDef *to_push) {
  ...
  if ((safety_mode_cnt > RELAY_TRNS_TIMEOUT) && (bus == 0) && (addr == FORD_LKA_CONTROL)) {
